...
function App() {
  ...
  return html`<${AppLayout} currentPage="side-quests" data=${data} setData=${setData} toast=${toast} setToast=${setToast} pageContent=${html`<${SideQuestsPage} data=${data} setData=${setData} />`} />`;
}
